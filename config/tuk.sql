...
--
-- tuk_Event_Manager Database`
--

DROP DATABASE IF EXISTS tuk;
CREATE DATABASE tuk;
USE tuk
...
CREATE TABLE `subscriptions` (
  ...
  `topic` varchar(256) DEFAULT '$XDSDocumentEntry',
...
CREATE TABLE `templates` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=6302 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
